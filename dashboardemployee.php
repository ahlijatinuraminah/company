    ...
    <div class="container">      
      <div id="navbar3" class="navbar-collapse collapse">
	    <ul class="nav navbar-nav"> 				            
			...
			<li><a href="dashboardemployee.php?p=profile">View Profile</a></li>	            
			<li><a href="dashboardemployee.php?p=viewproject">View Project</a></li>
			<li><a href="dashboardemployee.php?p=logout">Logout</a></li>			            
        </ul>
      </div>	    	
    </div>    
  </nav>  
